...
# add a few cities for reference (optional)
    ard = dict(arrowstyle="->")
    plt.annotate('Philadelphia', xy = (-75.16379, 39.95233), 
                   xytext = (-75.16379, 39.95233), arrowprops = ard)
    plt.annotate('Phoenix', xy = (-112.07404, 33.44838), 
                   xytext = (-112.07404, 33.44838), arrowprops= ard)
    plt.annotate('San Antonio', xy = (-98.49363, 29.42412), 
                   xytext = (-98.49363, 29.42412), arrowprops= ard)
    plt.annotate('Dallas', xy = (-96.80667, 32.78306), 
                   xytext = (-96.80667, 32.78306), arrowprops= ard)
    plt.annotate('Indianapolis', xy = (-86.15804, 39.76838), 
                   xytext = (-86.15804, 39.76838), arrowprops= ard)
    plt.annotate('Charlotte', xy = (-80.84313, 35.22709), 
                   xytext = (-80.84313, 35.22709), arrowprops= ard)
    params = plt.gcf()
